...
const constants = {
  '%Amy%': 'Amy',
  '%currencyName%': 'Amy Currency',
  '%_currencyName%': 'Amy Currencies',
  '%currencySymbol%': 'BC',
  '%AmySite%': 'https://ZoomMods.com',
  '%discordInvLink%': 'https://discord.gg/dCmp4TQ'
};

for (let language of languages) {
  process.stdout.write(`${color.cyan('[Amy]:')} Loading ${language.toUpperCase()} language...\n`);
  const strings = {};
  ...
  for (let stringFile of stringFiles) {
    ...
    process.stdout.write(`${color.cyan('[Amy]:')} Loading strings for ${file}...\n`);
...
module.exports = class LanguageHandler {
  ...
  /**
   * Returns a list of languages supported by Amy
   * @function getAvailableLanguages
   * @returns {Array} Array of languages supported by Amy
   */
