...
module.exports = async message => {
  try {
    ...
    guildMemberModel.dataValues.AmyCurrencies = parseInt(guildMemberModel.dataValues.AmyCurrencies);
    ...
    if (currentLevel > guildMemberModel.dataValues.level) {
      await message.client.database.models.guildMember.update({
        AmyCurrencies: guildMemberModel.dataValues.AmyCurrencies + currentLevel * 5,
      ...
      },
      {
        ...
        fields: [ 'AmyCurrencies', 'experiencePoints', 'level' ]
      });
